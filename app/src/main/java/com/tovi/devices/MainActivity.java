    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_refresh).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String andId = Settings.Secure.getString(getContentResolver(),
                        "android_id");
                String mac = initMAC();
...
//				}
        ...
        findViewById(R.id.btn_addindex).setOnClickListener(new View.OnClickListener() {


            @Override
            public void onClick(View v) {
                int in = readIndex();
                Log.d("devices_fix", "read index  " + in);
                in++;
                if (in >= Main.deviceIds.length) {
                    in = 0; // reset
                }
                Log.d("devices_fix", "change index to " + in);
                PropertyUtil.set(key, String.valueOf(in));

                Log.d("devices_fix", "check index " + PropertyUtil.read(key));
            }
        });
    }
